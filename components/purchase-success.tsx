...
export function PurchaseSuccess({ paymentId }: PurchaseSuccessProps) {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-green-600">
              Your payment is confirmed. The seller will be in touch to arrange delivery.
            </p>
          </div>
        </div>

        <div className="space-y-1.5">
          <p className="text-sm font-semibold text-zinc-700">Your Payment ID</p>
          ...
          <p className="text-xs text-green-600">
            Save this ID — you will need it to confirm you received the bicycle.
          </p>
        </div>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <Button asChild className="flex-1 h-12 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold">
          <Link href="/check-listing">Check Order Status</Link>
        </Button>
      </div>
    </div>
  )
